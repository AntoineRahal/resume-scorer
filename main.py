...
my_patterns_path = here.parents[0] / 'data/my_patterns.jsonl'
image_path = here.parents[0] / 'image/1554726063109.jpg'
tfidf_path = here.parents[0] / 'tfidf/tfidf.pkl'
